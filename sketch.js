...
var knifeImage , fruit1, fruit2 ,fruit3,fruit4, monsterImage, gameOverImage,fruit5,fruit6;
...
function preload(){
  ...
  fruit5=loadSound("knifeSwoosh.mp3");
  fruit6=loadSound("gameover.mp3");
...
function setup() {
  ...
  knife.setCollider("rectangle",0,0,70,130);
